(function () {
    ...
    function scrollToBottom(s) {
        setTimeout(function () {
            var chatElement = document.getElementById(s);
            if (!chatElement) return;

            var e = chatElement.querySelector(
                    "#chat-conversation .simplebar-content-wrapper"
                ),
                conversationList = document.getElementsByClassName(
                    "chat-conversation-list"
                )[0];

            if (!conversationList) return;

            var chatElement2 = document.getElementById(s);
            if (!chatElement2) return;

            var t = chatElement2.getElementsByClassName(
                "chat-conversation-list"
            )[0]
                ? chatElement2.getElementsByClassName(
                      "chat-conversation-list"
                  )[0].scrollHeight -
                  window.innerHeight +
                  335
    ...
    chatForm &&
        chatForm.addEventListener("submit", function (e) {
            ...
            0 === e.length
                ...
                : (1 == isreplyMessage
                      ? (getReplyChatList(s, e), (isreplyMessage = !1))
                      : getChatList(t, e),
                  scrollToBottom(t || s)),
                (chatInput.value = ""),
    ...
    var itemList = document.querySelector(".chat-conversation-list"),
        copyMessage = itemList
            ? itemList.querySelectorAll(".copy-message")
            : [];
    ...
    var deleteItems = itemList ? itemList.querySelectorAll(".delete-item") : [];
    ...
    var deleteImage = itemList ? itemList.querySelectorAll(".chat-list") : [];
    ...
    var replyMessage = itemList
            ? itemList.querySelectorAll(".reply-message")
            : [],
    ...
    var getChatList = function (e, t) {
            ...
            null != t &&
                s.insertAdjacentHTML(
                    ...
                    '<li class="chat-list right" id="chat-list-' +
                        ...
                        messageIds +
                        '">Copy <i class="bx bx-copy text-muted ms-2"></i></a>                                    <a class="dropdown-item d-flex align-items-center justify-content-between" href="#">Bookmark <i class="bx bx-bookmarks text-muted ms-2"></i></a>                                    <a class="dropdown-item d-flex align-items-center justify-content-between delete-item" id="delete-item-' +
                        messageIds +
            ...
            r.querySelectorAll(".delete-item").forEach(function (e) {
                ...
                r.querySelectorAll(".copy-message").forEach(function (e) {
                    e.addEventListener("click", function () {
                        var e =
                            r.childNodes[1].firstElementChild.firstElementChild
                ...
                r.querySelectorAll(".reply-message").forEach(function (n) {
                    n.addEventListener("click", function () {
                        var e = document.querySelector(".replyCard"),
                            ...
                            s =
                                n.closest(".ctext-wrap").children[0].children[0]
                                    .innerText,
                        ...
                        r =
                            !n.closest(".chat-list") ||
                            n.closest(".chat-list").classList.contains("left")
                                ? r
                                : "You";
                        (document.querySelector(
                            ".replyCard .replymessage-block .flex-grow-1 .conversation-name"
        ...
        getReplyChatList = function (e, t) {
            ...
            n.querySelectorAll(".delete-item").forEach(function (e) {
                ...
                n.querySelectorAll(".copy-message").forEach(function (e) {
                    e.addEventListener("click", function () {
                        n.childNodes[1].children[1].firstElementChild.firstElementChild.getAttribute(
                            "id"
                        ),
                            (isText =
                                n.childNodes[1].children[1].firstElementChild
