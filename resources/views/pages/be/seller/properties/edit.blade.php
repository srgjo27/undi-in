            ...
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <label class="form-label" for="title">Nama/Judul Properti <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <label class="form-label" for="description">Deskripsi Lengkap <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('latitude') is-invalid @enderror" 
                                               id="latitude" name="latitude" value="{{ old('latitude', $property->latitude) }}" step="any">
                                        @error('latitude')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('longitude') is-invalid @enderror" 
                                               id="longitude" name="longitude" value="{{ old('longitude', $property->longitude) }}" step="any">
                                        @error('longitude')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label class="form-label" for="land_area">Luas Tanah (m²) <span class="text-danger">*</span></label>
                                        <input type="number" class="form-control @error('land_area') is-invalid @enderror" 
                                               id="land_area" name="land_area" value="{{ old('land_area', $property->land_area) }}" required min="1">
                                        @error('land_area')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label class="form-label" for="building_area">Luas Bangunan (m²) <span class="text-danger">*</span></label>
                                        <input type="number" class="form-control @error('building_area') is-invalid @enderror" 
                                               id="building_area" name="building_area" value="{{ old('building_area', $property->building_area) }}" required min="1">
                                        @error('building_area')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label class="form-label" for="bedrooms">Kamar Tidur <span class="text-danger">*</span></label>
                                        <input type="number" class="form-control @error('bedrooms') is-invalid @enderror" 
                                               id="bedrooms" name="bedrooms" value="{{ old('bedrooms', $property->bedrooms) }}" required min="0">
                                        @error('bedrooms')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label class="form-label" for="bathrooms">Kamar Mandi <span class="text-danger">*</span></label>
                                        <input type="number" class="form-control @error('bathrooms') is-invalid @enderror" 
                                               id="bathrooms" name="bathrooms" value="{{ old('bathrooms', $property->bathrooms) }}" required min="0">
                                        @error('bathrooms')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                        ...
                        <div class="card-body">
                                        ...
                                        <div class="col-md-3 mb-3" id="image-{{ $image->id }}">
                                            <div class="card">
                                                <div class="position-relative">
                                                    ...
                                                    @if($image->is_primary)
                                                        <span class="position-absolute top-0 start-0 badge bg-primary m-2">Utama</span>
                                                    @endif
                                                ...
                                                <div class="card-body p-2">
                                                    <small class="text-muted">{{ $image->caption ?: 'Tidak ada caption' }}</small>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
                            ...
                            <div class="mb-3">
                                ...
                                @error('images')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <div class="form-text">Pilih beberapa gambar sekaligus. Format yang didukung: JPG, PNG, GIF. Maksimal 2MB per gambar.</div>
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                <label class="form-label" for="price">Harga Properti <span class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text">Rp</span>
                                    <input type="number" class="form-control @error('price') is-invalid @enderror" 
                                           id="price" name="price" value="{{ old('price', $property->price) }}" required min="0" step="1000000">
                                </div>
                                @error('price')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                <label class="form-label" for="coupon_price">Harga Kupon per Unit <span class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text">Rp</span>
                                    <input type="number" class="form-control @error('coupon_price') is-invalid @enderror" 
                                           id="coupon_price" name="coupon_price" value="{{ old('coupon_price', $property->coupon_price) }}" required min="0" step="1000">
                                </div>
                                @error('coupon_price')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('max_coupons') is-invalid @enderror" 
                                       id="max_coupons" name="max_coupons" value="{{ old('max_coupons', $property->max_coupons) }}" min="1">
                                @error('max_coupons')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                <label class="form-label" for="sale_start_date">Tanggal Mulai Penjualan <span class="text-danger">*</span></label>
                                <input type="datetime-local" class="form-control @error('sale_start_date') is-invalid @enderror" 
                                       ...
                                       value="{{ old('sale_start_date', $property->sale_start_date->format('Y-m-d\TH:i')) }}" required>
                            ...
                            <div class="mb-3">
                                <label class="form-label" for="sale_end_date">Tanggal Selesai Penjualan/Pengundian <span class="text-danger">*</span></label>
                                <input type="datetime-local" class="form-control @error('sale_end_date') is-invalid @enderror" 
                                       id="sale_end_date" name="sale_end_date" 
                                       value="{{ old('sale_end_date', $property->sale_end_date->format('Y-m-d\TH:i')) }}" required>
                                @error('sale_end_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            @if($property->sold_coupons > 0)
                                ...
                                <div class="text-center">
                                    ...
                                    <small class="text-muted">Tidak dapat mengubah beberapa pengaturan karena sudah ada penjualan</small>
                                </div>
                            @endif
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    imageInput.addEventListener('change', function(e) {
        ...
        primaryImageSelect.innerHTML = '<option value="">Tetap gunakan gambar utama saat ini</option>';
