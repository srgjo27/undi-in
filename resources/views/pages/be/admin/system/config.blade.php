                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="app_description" id="app_description" class="form-control @error('app_description') is-invalid @enderror" 
                                      rows="3">{{ old('app_description', $config['app']['description'] ?? '') }}</textarea>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="address" id="address" class="form-control @error('address') is-invalid @enderror" 
                                      rows="3">{{ old('address', $config['contact']['address'] ?? '') }}</textarea>
                            @error('address')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <select name="payment_gateway" id="payment_gateway" class="form-select @error('payment_gateway') is-invalid @enderror" required>
                                <option value="manual" {{ old('payment_gateway', $config['payment']['gateway'] ?? 'manual') === 'manual' ? 'selected' : '' }}>Manual Transfer</option>
                                <option value="midtrans" {{ old('payment_gateway', $config['payment']['gateway'] ?? 'manual') === 'midtrans' ? 'selected' : '' }}>Midtrans</option>
                                <option value="xendit" {{ old('payment_gateway', $config['payment']['gateway'] ?? 'manual') === 'xendit' ? 'selected' : '' }}>Xendit</option>
                            </select>
                        ...
                        <div id="midtrans-settings" style="display: none;">
                            ...
                            <div class="form-check mb-3">
                                <input class="form-check-input" type="checkbox" name="midtrans_is_production" id="midtrans_is_production" 
                                       value="1" {{ old('midtrans_is_production', $config['payment']['midtrans']['is_production'] ?? false) ? 'checked' : '' }}>
                                <label class="form-check-label" for="midtrans_is_production">
                                    Production Mode
                                </label>
                            </div>
                            
                            <button type="button" class="btn btn-sm btn-outline-primary" onclick="testPaymentGateway('midtrans')">
                        ...
                        <div id="xendit-settings" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-outline-primary" onclick="testPaymentGateway('xendit')">
                                <i class="fas fa-plug me-1"></i>Test Connection
                            </button>
                        </div>
                    </div>
