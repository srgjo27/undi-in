        ...
        <div class="col-12">
            <div class="page-header">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('admin.transactions.report') }}" class="btn btn-outline-primary">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h3 class="mb-0">{{ number_format($stats['success_transactions']) }}</h3>
                        </div>
                        <div class="flex-shrink-0">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h3 class="mb-0">Rp {{ number_format($stats['total_amount']) }}</h3>
                        </div>
                        <div class="flex-shrink-0">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <h6 class="mb-0">{{ Str::limit($transaction->order->property->title, 25) }}</h6>
                                            <small class="text-muted">{{ $transaction->order->quantity }} coupon(s)</small>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <span class="badge bg-{{ 
                                            ...
                                            ($transaction->status === 'cancelled' ? 'secondary' : 'warning')) 
                                        }}">
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="{{ route('admin.transactions.show', $transaction) }}" class="btn btn-sm btn-outline-info">
                                ...
                                <!-- Status Update Modal -->
                                @if(in_array($transaction->status, ['pending', 'processing']))
                                <div class="modal fade" id="statusModal{{ $transaction->id }}" tabindex="-1">
                                            ...
                                            <form action="{{ route('admin.transactions.update-status', $transaction) }}" method="POST">
                                                ...
                                                <div class="modal-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="status" id="status{{ $transaction->id }}" 
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea name="notes" id="notes{{ $transaction->id }}" 
