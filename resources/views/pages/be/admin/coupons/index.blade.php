                ...
                <div class="page-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex gap-2">
                            <a href="{{ route('admin.coupons.raffles') }}" class="btn btn-soft-secondary waves-effect waves-light">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                ...
                                <h3 class="mb-0 text-white">{{ number_format($totalProperties) }}</h3>
                            </div>
                            <div class="flex-shrink-0">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                ...
                                <h3 class="mb-0 text-white">{{ number_format($activeRaffles) }}</h3>
                            </div>
                            <div class="flex-shrink-0">
                                <i class="las la-dice fs-2 opacity-75"></i>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select name="is_winner" id="is_winner" class="form-select">
                                        ...
                                        <option value="0" {{ request('is_winner') === '0' ? 'selected' : '' }}>
                                            Participants</option>
                                        <option value="1" {{ request('is_winner') === '1' ? 'selected' : '' }}>Winners
                                        </option>
                                    </select>
                                </div>
                                <div class="col-md-4">
                                        ...
                                        <tr class="{{ $coupon->is_winner ? 'table-warning' : '' }}">
                                            ...
                                            <td>
                                                <div>
                                                    ...
                                                    <small class="text-muted">{{ $coupon->property->city }},
                                                        {{ $coupon->property->province }}</small>
                                                    <br><small class="text-success">Rp
                                                        {{ number_format($coupon->property->coupon_price) }}</small>
                                                </div>
                                            </td>
                                            <td>
                                                <div>
                                                    ...
                                                    @if ($coupon->buyer->phone_number)
                                                        <br><small
                                                            class="text-muted">{{ $coupon->buyer->phone_number }}</small>
                                                    @endif
                                                </div>
                                            </td>
                                            <td>
                                                <div>
                                                    ...
                                                    <br><small class="text-muted">Qty:
                                                        {{ $coupon->order->quantity }}</small>
                                                    <br><small class="text-success">Rp
                                                        {{ number_format($coupon->order->total_price) }}</small>
                                                </div>
                                            </td>
                                            <td>
                                                @if ($coupon->is_winner)
                                            ...
                                            <td>
                                                ...
                                                <br><small
                                                    class="text-muted">{{ $coupon->created_at->format('H:i') }}</small>
                                                <br><small
                                                    class="text-muted">{{ $coupon->created_at->diffForHumans() }}</small>
                                            </td>
                                            <td>
