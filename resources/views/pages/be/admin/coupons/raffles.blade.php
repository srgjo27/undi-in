                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        <a href="{{ route('admin.coupons.index') }}" class="btn btn-outline-secondary">
                            <i class="fas fa-ticket-alt me-2"></i>View All Coupons
                        </a>
                        <a href="{{ route('admin.coupons.report') }}" class="btn btn-outline-primary">
                            <i class="fas fa-chart-line me-2"></i>Coupon Report
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <form method="GET" action="{{ route('admin.coupons.raffles') }}">
                        <div class="row g-3">
                            <div class="col-md-4">
                                <label for="status" class="form-label">Raffle Status</label>
                                <select name="status" id="status" class="form-select">
                                    <option value="">All Status</option>
                                    <option value="pending" {{ request('status') === 'pending' ? 'selected' : '' }}>Pending (No Raffle)</option>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <img src="{{ asset('storage/' . $property->primaryImage()->image_path) }}" 
                                                 alt="{{ $property->title }}" class="me-2" style="width: 50px; height: 40px; object-fit: cover;">
                                            @else
                                            ...
                                            <div>
                                                ...
                                                <small class="text-muted">{{ $property->city }}, {{ $property->province }}</small>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <br><small class="text-muted">
                                            Revenue: Rp {{ number_format($property->coupons->count() * $property->coupon_price) }}
                                        </small>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <div>
                                            ...
                                            <br><small class="text-muted">Coupon: {{ $winner->coupon_number }}</small>
                                        </div>
                                        @else
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="{{ route('admin.coupons.raffle-detail', $property) }}" class="btn btn-sm btn-outline-info">
                                            ...
                                            <form action="{{ route('admin.coupons.conduct-raffle', $property) }}" method="POST">
                                                ...
                                                <div class="modal-body">
                                                    <div class="alert alert-info">
                                                        ...
                                                        <strong>{{ $property->coupons->count() }}</strong> coupons will participate in this raffle.
                                                        The system will randomly select one winner.
                                                    </div>
                                                    
                                                    <div class="mb-3">
                                                        <label for="draw_date{{ $property->id }}" class="form-label">Draw Date</label>
                                                        <input type="datetime-local" name="draw_date" id="draw_date{{ $property->id }}" 
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="border rounded p-2" style="max-height: 200px; overflow-y: auto;">
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-center py-1">
                                                                ...
                                                                <small class="text-muted">{{ $coupon->buyer->name }}</small>
                                                            </div>
                                                            @endforeach
                                                        </div>
                                                    </div>
