                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h3 class="mb-0">{{ number_format($activeProperties) }}</h3>
                        </div>
                        <div class="flex-shrink-0">
                                ...
                                <tr>
                                    <td>
                                        <div>
                                            ...
                                            <small class="text-muted">{{ $sale->city }}, {{ $sale->province }}</small>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <strong class="text-success">Rp {{ number_format($sale->total_revenue) }}</strong>
                                    </td>
                                    <td>
                                        <span class="text-muted">Rp {{ number_format($sale->coupon_price) }}</span>
                                    </td>
                                    <td>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="text-end">
                            ...
                            <br><small class="text-success">Rp {{ number_format($buyer->total_spent) }}</small>
                        </div>
                    </div>
                    <hr>
                    @endforeach
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <div class="text-end">
                            ...
                            <br><small class="text-success">Rp {{ number_format($trend->total_revenue) }}</small>
                        </div>
                    </div>
                    @endforeach
                    @else
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <strong class="text-success">Rp {{ number_format($sale->property->coupon_price) }}</strong>
                                    </td>
                                    <td>
                                        @if($sale->is_winner)
