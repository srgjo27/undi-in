        ...
        <div class="col-md-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <table class="table table-borderless">
                                ...
                                <tr>
                                    <th>Coupon Price:</th>
                                    <td><strong class="text-success">Rp {{ number_format($coupon->property->coupon_price) }}</strong></td>
                                </tr>
                                <tr>
                                    <th>Coupon Value:</th>
                                    <td><strong class="text-primary">Rp {{ number_format($coupon->property->coupon_price) }}</strong></td>
                                </tr>
                                <tr>
                                    <th>Status:</th>
                                    <td>
                                        <span class="badge bg-{{ $coupon->property->status === 'active' ? 'success' : 'secondary' }}">
                                            {{ ucfirst($coupon->property->status) }}
                                        </span>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <div class="mt-3">
                                <a href="{{ route('admin.properties.show', $coupon->property) }}" class="btn btn-sm btn-outline-primary">
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <table class="table table-borderless">
                                ...
                                <tr>
                                    <th>Total Amount:</th>
                                    <td><strong class="text-success">Rp {{ number_format($coupon->order->total_price) }}</strong></td>
                                </tr>
                                <tr>
                                    <th>Order Status:</th>
                                    <td>
                    ...
                    <div class="mt-3">
                        <a href="{{ route('admin.transactions.show', $coupon->order) }}" class="btn btn-sm btn-outline-primary">
                            <i class="fas fa-receipt me-1"></i>View Full Order Details
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        <a href="{{ route('admin.users.show', $coupon->buyer) }}" class="btn btn-sm btn-outline-primary w-100">
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-borderless table-sm">
                        <tr>
                            <th>Raffle Date:</th>
                            <td>{{ $raffle->raffle_date->format('M d, Y H:i') }}</td>
                        </tr>
                        <tr>
                            <th>Winner Coupon:</th>
                            <td><strong>{{ $raffle->winner_coupon_number }}</strong></td>
                        </tr>
                        <tr>
                            <th>Total Participants:</th>
                            <td>{{ $raffle->total_coupons }} coupons</td>
                        </tr>
                        <tr>
                            <th>Status:</th>
                            <td>
                    ...
                    @if($coupon->coupon_number === $raffle->winner_coupon_number)
                    ...
                    <div class="mt-3">
                        <a href="{{ route('admin.coupons.raffle-detail', $coupon->property) }}" class="btn btn-sm btn-outline-primary w-100">
                            <i class="fas fa-dice me-1"></i>View Raffle Details
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="card mt-4">
                ...
                <div class="card-body text-center">
                    ...
                    <a href="{{ route('admin.coupons.raffle-detail', $coupon->property) }}" class="btn btn-sm btn-primary">
                        <i class="fas fa-dice me-1"></i>Manage Raffle
                    </a>
                </div>
            </div>
            @endif
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <a href="{{ route('admin.coupons.index') }}" class="btn btn-outline-secondary">
                            <i class="fas fa-list me-2"></i>Back to Coupons List
                        </a>
                        <a href="{{ route('admin.properties.show', $coupon->property) }}" class="btn btn-outline-info">
                            <i class="fas fa-home me-2"></i>View Property
                        </a>
                        <a href="{{ route('admin.transactions.show', $coupon->order) }}" class="btn btn-outline-success">
