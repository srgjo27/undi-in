                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-2">
                            ...
                            {{ number_format($coupons->count() * $property->coupon_price) }}
                        </div>
                        <div class="mb-2">
                        ...
                        <div>
                            <strong>Notes:</strong>
                            <small class="text-muted">{{ $property->notes }}</small>
                        </div>
                        @endif
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        @else
                            ...
                            @if ($coupons->count() > 0)
                                ...
                                @else
                                    <button class="btn btn-secondary w-100" disabled title="Property must be verified and approved before conducting raffle">
                                        <i class="las la-shield-alt me-2"></i>Verification Required
                                    </button>
                                    <small class="text-muted mt-2 d-block">Property must be approved to conduct raffle</small>
                                @endif
                            @else
                                ...
                                <div class="border rounded p-3" style="max-height: 300px; overflow-y: auto;">
                                    <div class="row g-2">
                                        @foreach ($coupons as $coupon)
                                            <div class="col-md-6">
                                                <div
                                                    class="d-flex justify-content-between align-items-center py-2 px-3 bg-light rounded">
                                                    <div>
                                                        <strong>{{ $coupon->coupon_number }}</strong>
