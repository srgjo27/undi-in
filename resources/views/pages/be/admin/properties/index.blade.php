                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="d-flex gap-2">
                                        <button type="submit" class="btn btn-primary btn-label waves-effect waves-light"><i
                                                class="las la-search label-icon align-middle fs-16 me-2"></i>
                                            Search</button>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body py-2">
                        <form id="bulkActionForm" action="{{ route('admin.properties.bulk-status') }}" method="post">
                            @csrf
                            @method('patch')
                                        ...
                                        <tr>
                                            <td>
                                                @if ($property->status === 'completed')
                                                    <input type="checkbox" name="property_ids[]" value="{{ $property->id }}"
                                                        ...
                                                        title="Cannot select - Property already completed">
                                                @else
                                                    <input type="checkbox" name="property_ids[]"
                                                        value="{{ $property->id }}" class="form-check-input">
                                                @endif
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="mb-1">
                                                    ...
                                                    <br><small class="text-muted">Property Price</small>
                                                </div>
                                                <div>
                                                    <strong class="text-primary">Rp
                                                        {{ number_format($property->coupon_price) }}</strong>
                                                    <br><small class="text-muted">Coupon Price</small>
                                                </div>
                                                @if ($property->max_coupons)
                                                    <br><small class="text-info">Max:
                                                        ...
                                                        <form
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select name="status" id="status{{ $property->id }}"
                                        ...
                                        <tr>
                                            <td colspan="8" class="text-center py-4">
                                                <div class="text-muted">
                                                    <i class="las la-home fa-3x mb-3"></i>
