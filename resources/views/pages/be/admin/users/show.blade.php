    ...
    <div class="container-fluid">
        ...
        <div class="row g-4">
                                    ...
                                    <table class="table table-borderless mb-0">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-muted">{{ $user->created_at->format('F d, Y \a\t H:i') }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <th class="ps-0" scope="row">Last Updated</th>
                                                <td class="text-muted">{{ $user->updated_at->format('F d, Y \a\t H:i') }}
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-body p-4">
                        <h5>
                            <i class="las la-cogs text-primary"></i>
                            Quick Actions
                        </h5>
                            ...
                            <div class="d-grid gap-3">
                                <form action="{{ route('admin.users.toggle-status', $user) }}" method="POST">
                                    ...
                                    <button type="submit"
                                        ...
                                        <i
                                            class="las la-{{ $user->email_verified_at ? 'user-lock' : 'user-check' }} me-2"></i>
                        ...
                        @else
                            <div class="text-center py-4">
                                ...
                                <p class="text-muted">You cannot perform actions on your own account for security reasons.
                                </p>
                            </div>
                        @endif
                    </div>
        ...
        @if ($user->role === 'seller' || $user->role === 'buyer')
            <div class="row g-4 mb-4">
                <div class="col-12">
                    <h5>
                        <i class="las la-chart-bar text-primary"></i>
                        Activity Statistics
                    </h5>
                </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div>
                            <div class="text-success">
                                {{ $user->properties->where('status', 'active')->count() }}</div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div>
                            <div class="text-warning">
                                {{ $user->properties->where('status', 'draft')->count() }}</div>
                        ...
                        <div>
                            <div class="d-flex justify-content-between align-items-start mb-2">
                                ...
                                <div class="d-flex flex-column align-items-end gap-1">
                                    <span
                                        class="badge {{ $property->status_badge }}">
